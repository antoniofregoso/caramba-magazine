...
class ResConfigSettings(models.TransientModel):
    ...
    opinion = fields.Boolean('Opinion Section', related='website_id.opinion')
    carousel = fields.Boolean('Categories Carousels', related='website_id.carousel')
    carousel_size = fields.Integer('Carousel Size', related='website_id.carousel_size')
